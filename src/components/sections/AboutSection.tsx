        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <FadeUp>
            ...
            <div className="space-y-5 text-[15px] leading-[1.85]" style={{ color: "var(--ink-400)" }}>
              <p>Over <strong style={{ color: "var(--ink)", fontWeight: 600 }}> 5 years</strong> I&apos;ve owned entire product stacks — from pixel-perfect React interfaces to Node.js APIs, cloud infrastructure, and system architecture — on products where failure isn&apos;t an option: <strong style={{ color: "var(--ink)", fontWeight: 600 }}>live NHS healthcare platforms</strong> serving thousands of patients across England.</p>
